...
MONGO_URI_WORKERS = "mongodb://mongodb_pfe:27017/"
DB_NAME           = "telecom_algerie"
COLLECTION_SOURCE = "commentaires_sans_emojis_combinision"   
COLLECTION_DEST   = "commentaires_normalises"
BATCH_SIZE        = 1000
NB_WORKERS        = 3
SPARK_MASTER      = "spark://spark-master:7077"
...
# # NB_WORKERS        = 3
# # SPARK_MASTER      = "spark://spark-master:7077"
# # RAPPORT_PATH      = "/home/mouna/projet_telecom/scripts/nettoyage/Rapports/rapport_normalisation.txt"
# # HORS_SCOPE_PATH   = "/home/mouna/projet_telecom/scripts/nettoyage/Rapports/hors_scope_comments.json"
...
# #             {"_id": {"$in": valid_ids}},
# #             {"$set": {"traite": True, "date_traitement_normalisation": datetime.now()}}
# #         )
...
# #     "adsl", "vdsl", "ftth", "fttb", "xgs", "xgs-pon", "pon", "dsl",
# #     "lte", "volte", "dns", "ont", "wifi", "wify", "wi-fi", "wlan",
# #     "4g", "3g", "2g", "5g", "cnx", "rdm", "mbps", "kbps", "gbps",
# #     "idoom", "djezzy", "mobilis", "ooredoo", "fibre", "ping", "gaming",
# # }

# # _PROTECTED_COMPOUNDS: List[str] = [
# #     "my idoom", "fibre optique", "core network", "traffic shaping",
# # ]

# # HORS_SCOPE_KEYWORDS: List[str] = [
# #     "embauche", "recrutement", "offre d'emploi", "sarl maxim",
# # ]

# # # ============================================================
# # # TEXT NORMALIZER v3.9.5
# # # ============================================================
...
# #                 d = json.load(f)
# #         except:
# #             # Dictionnaires par défaut si fichiers non trouvés
# #             d = {
# #                 "unicode_arabic": {"ة": "ه", "ؤ": "و"},
# #                 "arabizi_digrams": {},
# #                 "arabizi_monograms": {},
# #                 "arabizi_words": _EXTRA_ARABIZI_WORDS if '_EXTRA_ARABIZI_WORDS' in dir() else {},
# #                 "arabizi_upper": {},
# #                 "emojis": {},
# #                 "abbreviations": {},
# #                 "telecom_tech": {},
# #                 "units": {},
# #                 "network_variants": {"normalized_form": "internet", "latin": [], "arabic": []},
# #                 "mixed_ar_fr_regex": {},
# #                 "french_corrections_regex": {},
# #             }

# #         # Initialisation simplifiée pour l'exemple
# #         self.arabizi_words = d.get("arabizi_words", {})
# #         self.arabizi_upper = d.get("arabizi_upper", {})
# #         self.arabizi_upper_sorted = sorted(self.arabizi_upper.items(), key=lambda x: len(x[0]), reverse=True)
# #         self.arabizi_seq = []
# #         self.emojis = d.get("emojis", {})
# #         self.units_map = d.get("units", {})
# #         self.telecom = d.get("telecom_tech", {})
# #         self.abbreviations = d.get("abbreviations", {})
# #         self._tech_tokens = _ABBREV_KEYS_TO_PROTECT
# #         self._negations = set()
# #         self._dialect_keep = set()
# #         self._intentional_rep = set()
# #         self._arabic_prefixes = ["ال", "و", "ف", "ب", "ك", "ل"]
# #         self._contractions = {}
# #         self._contraction_re = re.compile(r"(?!)")
# #         self._mixed_pats = []
# #         self._fr_pats = []
# #         self._net_re = None
# #         self._stopwords = set()
...
# #         # Dans la vraie version, cette fonction contient toute la logique de normalisation
# #         result = text.lower().strip()
# #         # Suppression des caractères spéciaux
# #         result = re.sub(r'[^\w\s\u0600-\u06FF]', ' ', result)
...
# #     for row in partition:
# #         texte_original = row.get("Commentaire_Client", "") or ""
# #         original_id = row.get("original_id", str(row.get("_id", "")))

# #         ids_traites.append(original_id)

# #         # Vérifier hors scope
# #         is_hors = False
# #         for kw in HORS_SCOPE_KEYWORDS:
# #             if kw.lower() in texte_original.lower():
# #                 is_hors = True
# #                 break
...
# #             normalized_full = normalizer_full.normalize(texte_original)
# #         except:
# #             normalized_arabert = texte_original
# #             normalized_full = texte_original
...
# #         for key, value in row.items():
# #             if key not in ["_id", "original_id", "Commentaire_Client"]:
# #                 doc[key] = value
...
# #     print("=" * 70)
# #     print("🔤 NORMALISATION MULTI-NŒUDS v3.9.5 (avec flag traite)")
# #     print("   Génère 2 colonnes : normalized_arabert, normalized_full")
# #     print("   ✅ GESTION FLAG traite : lit traite=false, écrit traite=false, marque traite=true")
# #     print(f"   Source : {COLLECTION_SOURCE} (traite=false)")
# #     print(f"   Destination : {COLLECTION_DEST} (traite=false)")
# #     print("=" * 70)
...
# #     print(f"✅ MongoDB connecté — {total_docs} documents à traiter")

# #     # Connexion Spark
# #     print("\n⚡ Connexion au cluster Spark...")
# #     spark = SparkSession.builder \
# #         .appName("Normalisation_With_Traite") \
# #         .master(SPARK_MASTER) \
# #         .config("spark.executor.memory", "2g") \
# #         .config("spark.executor.cores", "2") \
# #         .getOrCreate()
# #     spark.sparkContext.setLogLevel("WARN")
# #     print("✅ Spark connecté")
...
# #     df_spark = spark.read.json(rdd_data.map(
# #         lambda d: json.dumps({k: str(v) if not isinstance(v, (str, int, float, bool, type(None))) else v
...
# #     total_hors = sum(s.get("docs_hors_scope", 0) for s in stats if s.get("statut") == "ok")
...
# #         with open(HORS_SCOPE_PATH, "w", encoding="utf-8") as f:
# #             json.dump(all_hors_scope, f, ensure_ascii=False, indent=2)
# #         print(f"📝 {len(all_hors_scope)} commentaires hors scope sauvegardés")
...
# #     total_en_dest = coll_dest.count_documents({})
# #     print(f"\n🔎 VÉRIFICATION FINALE...")
# #     print(f"   • Documents source (traités) : {total_lignes}")
# #     print(f"   • Documents normalisés       : {total_inseres}")
