...
# import os, time, math
# from spark_reporter import SparkReporter  # ← ajouter cette ligne
# # ============================================================
...
#         # FIX-C7d : convertir dates avec espaces EN TOUT PREMIER
#         # "من 18 10 2025" → "من 18/10/2025"
...
#         # FIX-C8 : réduire ponctuation répétée → 1 seule
...
#         # Supprimer ponctuation indésirable
#         texte = re_ponct_sup.sub(' ', texte)

#         # Supprimer tirets non numériques
#         texte = re_tiret_non_num.sub(' ', texte)

#         # Nettoyer espaces
#         texte = re_espaces.sub(' ', texte).strip()

#         # Restaurer dates et séparateurs
...
#         # FIX-C8 : ligne que ponctuation → vide → ignorée
...
#     yield {"docs_traites": docs_traites, "docs_vides": docs_vides,
#            "statut": "ok"}
...
#     reporter.spark_connected(elapsed_spark=round(temps_fin_spark - temps_debut_spark, 2))
# except Exception as e:
...
# reporter.loading_done(total_lignes=total_lignes,
...
# # 7. RAPPORT FINAL — même format que le terminal
...
# # Test avec 1 partition (séquentiel)
...
# # Test avec 3 partitions (parallèle)
